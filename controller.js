...
*/
    ...
    <div class ="col-xs-3">
      <div class="player-card">
          <div class="card" style="width: 20rem;">
                    <img class="card-img-top" src="${player.photo}" width="197px" height="200px"alt="Card image cap">
                    <div class="card-block black">
  ...
  function drawMyTeam(playersList) {
    ...
    <div class ="col-xs-3">
      <div class="player-card">
          <div class="card" style="width: 20rem;">
                    <img class="card-img-top" src="${player.photo}" width="197x" height="200px"alt="Card image cap">
                    <div class="card-block black">
                       <p class="card-text text-center fullname">${player.fullname}</p>
                       <p class="card-text text-center">${player.pro_team}</p>
                       <p class="card-text text-center">${player.position}</p>
